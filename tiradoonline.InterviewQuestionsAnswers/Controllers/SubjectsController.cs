...
namespace tiradoonline.InterviewQuestionsAnswers.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubjectID,Subject,create_dt")] Subjects subjects)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubjectID,Subject,create_dt")] Subjects subjects)
        {
            if (ModelState.IsValid)
            {
